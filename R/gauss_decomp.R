...
checkR=-Inf
while(checkR==-Inf||is.na(median(checkR))){
...
mean(theta_post_true[5001:55000])
hist(theta_post_true[5001:55000],col=c1,add=TRUE,freq=FALSE)
abline(v=mean(theta_post_true[5001:55000]),col="blue",lwd=2)
